      ...
      <Router>
        <Stack hideNavBar key="root">
          <Drawer
            ...
            key="drawer"
          >
            <Scene title={"Home"} key="home" initial component={Home}></Scene>
            <Scene title={"Profile"} key="profile" component={Profile}></Scene>
            <Scene title={"Invoice"} key="invoice" component={Invoice}></Scene>
